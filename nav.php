        ...
        <div class="center bg-side col-auto col-md-3 col-xl-2 px-sm-2 px-0 min-vh-100">
            ...
            <li class="my-2">
                ...
                <ul class="collapse nav flex-column ms-1 px-3" id="submenu" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="#" class="nav-link p-2 rounded-1"> <span class="d-none d-sm-inline">Attendance Tracking</span> 1</a>
                    </li>
                    <li>
                        <a href="#" class="nav-link disabled p-2 rounded-1"> <span class="d-none d-sm-inline">#</span> 2</a>
                    </li>
                </ul>
            </li>
            <li class="my-2">
                ...
                <ul class="collapse nav flex-column ms-1 px-3" id="submenu1" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="#" class="nav-link p-2 rounded-1"> <span class="d-none d-sm-inline">Item</span> 1</a>
                    </li>
                    <li>
                        <a href="#" class="nav-link p-2 rounded-1"> <span class="d-none d-sm-inline">Item</span> 2</a>
                    </li>
                </ul>
            </li>
            <li class="my-2">
